...
def dashboard_snapshot_to_dict(
    ...
    return {
        ...
        "system_health": (
            {
                ...
                "checked_at": (
                    system_health.checked_at.isoformat()
                ),
                "reasons": list(system_health.reasons),
                "requires_attention": (
                    system_health.requires_attention
                ),
            }
        ...
        "runtime_metrics": (
            {
                "generated_at": (
                    runtime_metrics.generated_at.isoformat()
                ),
                "counts": {
                    metric.value: count
                    for metric, count
                    in runtime_metrics.counts.items()
                },
        ...
        "live_summary": (
            {
                "trading_date": (
                    live_summary.trading_date.isoformat()
                ),
                "log_count": live_summary.log_count,
                "cycle_started_count": (
                    live_summary.cycle_started_count
                ),
                "cycle_completed_count": (
                    live_summary.cycle_completed_count
                ),
                "market_poll_count": (
                    live_summary.market_poll_count
                ),
                "signal_count": live_summary.signal_count,
                "risk_rejected_count": (
                    live_summary.risk_rejected_count
                ),
                "risk_halted_count": (
                    live_summary.risk_halted_count
                ),
                "order_count": live_summary.order_count,
                "execution_count": (
                    live_summary.execution_count
                ),
