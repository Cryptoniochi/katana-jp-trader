...
if "%KABU_STATION_API_PASSWORD%"=="" (
  ...
  echo Set it in this terminal before starting KATANA.
  exit /b 1
)
...
set LOG_PATH=logs\sprint91\full_session_%STAMP%.log

echo Project KATANA Sprint91-2 Full Session
...
echo.
echo Confirm kabu Station is running and logged in.
echo.
