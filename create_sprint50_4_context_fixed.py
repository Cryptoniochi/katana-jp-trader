...
DEFAULT_OUTPUT = "sprint50_4_context.txt"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Project KATANA Sprint50-4用のコンテキストファイルを生成します。"
        )
    )
    parser.add_argument(
        "--root",
...
def render_context(
    ...
    lines: list[str] = [
        "# Project KATANA Sprint50-4 Context",
        "",
        f"Project root: {root}",
        ...
        "## Target",
        "",
        "Sprint50-4: Best Parameter Automation",
        "- Save the best optimization parameter",
        "- Export best_parameters.json",
        "- Optionally apply the best parameter to a follow-up backtest",
