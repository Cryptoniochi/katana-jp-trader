...
DEFAULT_OUTPUT = "sprint51_2_context.txt"
...
TARGET_FILES: tuple[str, ...] = (
    ...
    "tests/test_walk_forward_window_service.py",
)
...
def main() -> int:
    ...
    try:
        collected, missing = collect_files(
            root,
            TARGET_FILES,
        )
